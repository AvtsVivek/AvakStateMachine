...
namespace Avak.StateMachine.Core.Implimentation
{
    internal class XmlStateFileReader : IStateFileReader
    {
        ...
        internal XmlStateFileReader(IXmlKeys constants, StateDependencyTypeFinder stateDependencyTypeFinderDelegate)
        {
            if (stateDependencyTypeFinderDelegate == null)
            {
                string message = $"The argument/parameter to the constructor of the type {typeof(StateMachineManager).FullName}, {nameof(XmlStateFileReader.stateDependencyTypeFinderDelegate)} of type {typeof(StateDependencyTypeFinder).FullName} cannot be null." +
        ...
        //private MasterStateBase CreateAndSetInitialState()
        //{
        //    XAttribute? initialAttribute = currentStateXmlFile.stateCollectionElement!
        ...
        //        initialStateElement = currentStateXmlFile.stateElements[0];
        ...
        //        initialStateElement = currentStateXmlFile.GetStateElement(initialAttribute.Value)!;
        ...
        //{
        //    XElement stateElement = currentStateXmlFile.GetStateElement(state.Name)!;
        ...
        //        XElement? targetStateElement = currentStateXmlFile.GetStateElement(targetAttribute!.Value)!;
        ...
        //private void PopulateStateTypeCtorInfoObject()
        //{
        //    List<string> uniqueStateNameList = []; // Used to check state names are unique in the state file.

        //    foreach (XElement stateElement in currentStateXmlFile.stateElements)
        //    {
        ...
        //    {
        //        stateNamespace = currentStateXmlFile.RootNamespace;
        //    }
        ...
        //    Trigger? triggerForTransition = currentStateXmlFile.Triggers
        ...
        //if (stateXmlFile.Triggers.Count != 0)
        //{
        //    // already read.
        //    return;
        //}

        //foreach (XElement triggerElement in stateXmlFile.triggerElements)
        //{
        ...
        //{
        //    if (!string.IsNullOrWhiteSpace(stateXmlFile.RootNamespace))
        //        return;
        ...
        //    stateXmlFile.RootNamespace = rootNamespaceAttribute.Value;
        //}
    }
}
